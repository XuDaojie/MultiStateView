...
public class BaseMultiStateView extends FrameLayout {
    ...
    private static final String TAG = BaseMultiStateView.class.getSimpleName();
    ...
    public BaseMultiStateView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private boolean isValidContentView() {
